...
namespace Unity.Netcode
{
        ...
        where TValue : unmanaged
    {
        ...
        public NetworkDictionary(NetworkVariableReadPermission readPerm, NetworkVariableWritePermission writePerm, IDictionary<TKey, TValue> values) : base(readPerm, writePerm)
        {
